                        ...
                        <div className="bg-[#1e1e1e] border border-[#2a2a2a] p-8 rounded-[2.5rem]">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-500 text-xs">Ajusta tu meta de ahorro mensual.</p>
                                </div>
                            </div>
                        ...
                        <div className={`p-6 rounded-3xl border ${status.bg} ${status.border} flex items-start gap-4 transition-all duration-500`}>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-sm text-zinc-300 leading-relaxed">
                                    {porcentaje >= 100
                                        ? `Has superado tu límite por S/. ${Math.abs(margen).toLocaleString()}.`
                                        : `Vas por buen camino. Te quedan S/. ${margen.toLocaleString()} disponibles.`}
                                </p>
                            </div>
                        </div>
                    </div>
